...
<body style="background-color: #E20E2D;">
                            ...
                            <div class="col-lg-6" style="padding-left: 100px;">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">MỜI ĐĂNG NHẬP</h1>
                                    </div>
                                    <form class="user" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="txtmatkhau" class=" form-control form-control-user" id="exampleInputPassword" placeholder="Nhập mật khẩu..." required>
                                        </div>
                                        <div class="form-group">
