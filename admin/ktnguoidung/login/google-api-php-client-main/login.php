...
$client_id = '378640719220-mmf2onjvg5g8h1gick1td68upnbvdvkr.apps.googleusercontent.com';
$client_secret = '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';
$redirect_uri = 'http://127.0.0.1/webbanmypham/admin/ktnguoidung/index.php';

//Thông tin kết nói database
$db_username = "root"; //Database Username
$db_password = ""; //Database Password
$host_name = "localhost"; //Mysql Hostname
$db_name = 'chmypham'; //Database Name
###################################################################
