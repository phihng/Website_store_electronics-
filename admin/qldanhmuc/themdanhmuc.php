...
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 style="color: #EA0029;" class="m-0 font-weight-bold ">THÊM DANH MỤC</h6>
        </div>
        <div class="card-body">
            <form class="was-validated" method="post" enctype="multipart/form-data">
                ...
                <div class="col md-3 mt-3">
                        ...
                        <input class="form-control" type="text" name="txttentbdt" required>
                        <div class="valid-feedback">Hợp lệ.</div>
                        <div class="invalid-feedback">Hãy điền tên danh mục.</div>
                    </div>
                    <div class="col md-3 mt-3">
